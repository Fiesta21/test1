...
DECLARE
    ...
    g_cust_file_name        CONSTANT VARCHAR2( 32 )  := 'XXPHA_EAM336_PKG.main';
    g_cust_short_name       CONSTANT VARCHAR2( 16 )  := 'XXPHA_EAM336';
    ...
    TYPE XXPHA_EAM336_PROCESS_TYPE IS TABLE OF VARCHAR2( 256 ) INDEX BY BINARY_INTEGER;

    t_perms_values XXPHA_EAM336_PROCESS_TYPE;                                                                  -- Список полномочий по умолчанию
