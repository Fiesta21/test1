CREATE OR REPLACE PACKAGE XXPHA_EAM336_PKG IS
/* $Id: XX_EAM336_PKG.sql 1.0 xx/xx/xxxx-00:00 login $ */
...
END XXPHA_EAM336_PKG;
/
CREATE OR REPLACE PACKAGE BODY XXPHA_EAM336_PKG IS
/* $Id: XX_EAM336_PKG.sql 1.0 xx/xx/xxxx-00:00 login $ */
...
/*
   PROCEDURE xxpha_log( p_msg    IN VARCHAR2
    ...
    is
    BEGIN
        xxpha_pnaumov_pkg.gb_log_mark := 'EAM336';
